...
* Application layer
*/
void cutMessage(unsigned char *message, off_t *indice, int *sizeDataPacket, off_t FileSize, unsigned char *data_packet);

/*
* It appends the packet header to the begginning of data packets
* Application layer
*/
void packetHeader(unsigned char *message, char *final_data_packet, int *sizeDataPacket, off_t FileSize);
